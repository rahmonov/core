...
from masonite.helpers.routes import flatten_routes, compile_routes_to_dictionary
...
class AppProvider(ServiceProvider):
    ...
    def register(self):
        ...
        self.app.bind('CompiledRoutes', compile_routes_to_dictionary(flatten_routes(web.ROUTES)))
